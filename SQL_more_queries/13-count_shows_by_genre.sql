...
-- lists all genres. First column must be called genre and the second, number_of_shows. Results must be sorted in descending order by the number of shows linked.
