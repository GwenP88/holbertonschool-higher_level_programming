...
-- lists all shows contained. Results must be sorted in ascending order by tv_shows.title and tv_show_genres.genre_id. If show doesn't have genre, display NULL.
