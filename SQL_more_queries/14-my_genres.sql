...
-- lists all genres of the show Dexter. First column must be called genre and the second, number_of_shows. Results must be sorted in ascending order by the genre name
